function Transcript {
    ...
    [string]$transcript = (".\logs\Berechtigungsmatrix\"+(get-date -Format "yyyy-MM-dd-HH-mm-ss")+"Entfernung"+".log")
...
if($error.length -gt 0){
	...
	write-host "$Benutzername aus $Groupname entfernt" -BackgroundColor Yellow -ForegroundColor black
}
